  ...
  function validateResponse(range, response) {
    ...
    return {
      ...
      bookings: {
        ...
        cancelledCount: nonNegativeInt(response.bookings.cancelledCount),
        refundedCount: nonNegativeInt(response.bookings.refundedCount),
      ...
      refunds: { status: response.status, count: nonNegativeInt(response.bookings.refundedCount), pendingCount: nonNegativeInt(response.bookings.refundedCount), refundedAmount: money(response.finance && response.finance.refundAmount) },
