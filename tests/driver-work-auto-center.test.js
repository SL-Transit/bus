...
(async () => {
  ...
  assert(index.includes("exports.refreshDailyDriverWork"), "scheduled driver work function must be exported");
  assert(index.includes('schedule: "every 5 minutes"'), "driver work must refresh during the day");
