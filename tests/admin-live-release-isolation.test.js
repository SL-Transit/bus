...
const allowed = new Set([
  ...
  'admin-erp-excel-draft-import.js',
  'admin-erp-excel-import-controller.js',
  'admin-erp-draft-adapter.js',
  'admin-erp-firebase-config.js',
  'admin-erp-read-model.js',
  'erp-workbook-source-contract.js',
  'admin-erp1-integration.js',
  'admin-erp1-network-integration.js',
  'tests/admin-erp1-network-publish.test.js',
  'admin-erp1.html',
  ...
  'tests/admin-erp-excel-draft-import.test.js',
  'tests/admin-erp1-excel-import-wiring.test.js',
  ...
  'tests/erp-workbook-source-contract.test.js',
