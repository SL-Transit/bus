...
const allowed = new Set(['admin-erp.html', 'tests/admin-console-browser.spec.js', 'tests/admin-live-release-isolation.test.js', 'tests/admin-enterprise-ux.test.js', 'tests/admin-console-ui-contract.test.js', '.github/workflows/admin-live-release.yml', 'docs/admin-erp-enterprise-ux-blueprint.md']);
