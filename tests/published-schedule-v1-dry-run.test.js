...
(async function main() {
  ...
  assert(schedule.mapView.displayPolicy.stopMarkers.iconSizePx === 34, 'mapView must centrally define stop icon screen size');
  assert(schedule.mapView.displayPolicy.stopMarkers.iconFontSizePx === 18, 'mapView must centrally define stop icon font size');
  assert(schedule.mapView.displayPolicy.stopMarkers.labelFontSizePx === 11, 'mapView must centrally define stop label font size');
