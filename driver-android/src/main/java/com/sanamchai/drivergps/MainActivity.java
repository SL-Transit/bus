...
public class MainActivity extends Activity {
    ...
    private LinearLayout buildActionButton(int drawableResId, String label, int accentColor, android.view.View.OnClickListener onClick) {
        ...
        // วงกลม 44x44dp คงที่ทุกอัน
        FrameLayout iconWrap = new FrameLayout(this);
        GradientDrawable iconBg = new GradientDrawable();
        iconBg.setShape(GradientDrawable.OVAL);
        iconBg.setColor(accentColor);
        iconWrap.setBackground(iconBg);
        LinearLayout.LayoutParams wrapLp = new LinearLayout.LayoutParams(dp(44), dp(44));
        ...
        iconImg.setColorFilter(Color.WHITE, android.graphics.PorterDuff.Mode.SRC_IN);
        FrameLayout.LayoutParams imgLp = new FrameLayout.LayoutParams(dp(26), dp(26));
