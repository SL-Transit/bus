...
exports.createBooking = onRequest({
  ...
  try {
    ...
    const booking = {
      ...
      routeId: pair.routeId, tripId: pair.scheduleOfferId, catalogTripId: pair.scheduleOfferId,
      scheduleOfferId: pair.scheduleOfferId, scheduleRowId: pair.scheduleRowId,
