...
| ERP Data Center import guard round 2 | Main Backbone Support AI | IN_PROGRESS | `erp-import-plan.js`, `erp-schema.js`, `erp-data-adapter.js`, handoff docs | 2026-07-10 00:00 +07 | 2026-07-10 00:00 +07 | pending | Patch nested forbidden descendants under `data/erpDataCenter/*`; Firebase writes none. |
