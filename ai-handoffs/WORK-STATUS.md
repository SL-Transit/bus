...
| ERP Data Center import guard | Main Backbone Support AI | IN_PROGRESS | `erp-import-plan.js`, `erp-schema.js`, `erp-data-adapter.js`, `admin-erp.html`, handoff docs | 2026-07-08 00:00 +07 | 2026-07-08 00:00 +07 | pending | Guard patch only: seed/import target must be `data/erpDataCenter/*`; Firebase writes none. |
