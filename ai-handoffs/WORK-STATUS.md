...
| Passenger bridge | Passenger AI | BLOCKED | `passenger.html`, `passenger-logic.js` — page has no Firebase connection at all (see CENTRAL-REPORT.md 22:35 entry: missing real sl-transit-9464e apiKey, repo-wide) | 2026-07-05 17:36 +07 | 2026-07-05 22:35 +07 | see `ai-handoffs/CENTRAL-REPORT.md` (22:35 entry) and `ai-handoffs/passenger-bridge-plan.md` | Needs real Firebase credentials + catalog seed before passenger can show any live data again. Cross-cutting — booking.html/check_ticket.html still on old project too. |
...
| Live vehicle import validator | Main Backbone Lead AI | IN_PROGRESS | `erp-schema.js`, `ai-handoffs/WORK-STATUS.md`, `ai-handoffs/CENTRAL-REPORT.md` | 2026-07-06 00:10 +07 | 2026-07-06 00:10 +07 | `pending` | Allow empty `operations/liveVehicles` for dry-run import review; no Firebase writes; no booking/passenger data. |
