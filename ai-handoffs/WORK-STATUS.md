...
| ERP Data Center import guard round 2 | Main Backbone Support AI | REVIEW | `erp-import-plan.js`, `erp-schema.js`, `erp-data-adapter.js`, handoff docs | 2026-07-10 00:00 +07 | 2026-07-10 00:00 +07 | pending commit | Patch nested forbidden descendants/subtrees under `data/erpDataCenter/*` and gate adapter private writes; Firebase writes none. |
