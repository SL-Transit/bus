...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Booking remaining seats display | Supervisor AI / Project Secretary | REVIEW | `booking-bridge.js`, `booking1-preview-adapter.js` tests, handoff docs | 2026-07-22 00:35 +07 | 2026-07-22 00:35 +07 | PR #10 / branch `agent/booking-remaining-seats-display`; resolving latest main conflict | Booking Bridge now reads central `operations/bookingCapacityByServiceDate` counters and returns `availabilityDecision.seatsAvailable` for Booking1 display. Firebase writes/seed/production apply: none. `database.rules.json` and driver identity untouched. |
...
| Booking1 notification center bridge | Supervisor AI / Project Secretary | DONE | `booking1-preview-adapter.js`, `booking-assignment-center.js`, `functions/index.js`, `functions/staff-notification-center.js`, `functions/driver-ticket-center.js`, notification tests | 2026-07-18 20:55 +07 | 2026-07-22 00:35 +07 | `a8391b1`, `a3ddf9e`, `908beda`, `5e9e3dc`; see CENTRAL-REPORT 2026-07-18 20:55 +07 | Booking1 writes `/bookings/{code}`; ERP Notification Center resolves staff recipients from `/data/notificationCenter/staffLineTargets`; driver assignment enrichment uses `operations/driverWorkByServiceDate` plus ERP Data Center stop aliases. `car1`, `car3/2575`, `car4/2649` ready; owner has now provided `car2` LINE user ID evidence, but Firebase central config write remains pending separate owner approval. |
