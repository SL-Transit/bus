## 2026-08-09 +07 - บันทึกหลักการเลือกเส้นทาง ป้าย และจุดต่อรถ - REVIEW
...
สรุป:
- บันทึกมติเจ้าของเรื่องการแยกกลุ่มบริการ สถานที่จริง ป้าย สาย แบบเส้นทาง เที่ยว เวลา ราคา และกฎการต่อรถ
- กำหนดหน้าผู้โดยสารให้แสดงข้อมูลจากศูนย์กลางและแสดงเฉพาะเที่ยวหรือทางต่อที่เกิดขึ้นได้จริงตามวัน เวลา ลำดับป้าย และกฎการต่อรถ
- กำหนดหลักค้นหาเที่ยวตรงก่อน แล้วค้นหาทางต่อเป็นรอบ พร้อมตรวจเวลาต่อขั้นต่ำและเรียงผลตามเวลา จำนวนครั้งที่ต่อ เวลารอ และราคา
- ย้ำว่าชื่อ สถานที่ สาย จุดเชื่อมต่อ เวลา ราคา จำนวนกลุ่ม และสถานการณ์ในบทสนทนาเป็นตัวอย่าง ห้ามนำไปเป็นข้อมูลจริง
- กำหนดให้ผู้ช่วยทุกตัวอ่านมติล่าสุดก่อนเริ่มงาน และต้องขออนุมัติใหม่ก่อนแก้โค้ดหรือข้อมูลจริง

หลักฐาน:
- กิ่งงาน: `docs/route-planning-principles-20260809`
- คำขอตรวจทานแบบร่าง: https://github.com/SL-Transit/bus/pull/139
- การเปลี่ยนแปลงเป็นเอกสารเท่านั้น

ความปลอดภัย:
- ไม่แก้โค้ดทำงานจริง
- ไม่เขียน Firebase หรือฐานข้อมูล
- ไม่นำเข้าหรือเผยแพร่ข้อมูลจริง
- ไม่สร้างหรือแตะข้อมูลการจองและผู้โดยสาร
- ไม่รวมเข้ากิ่งหลักและไม่เผยแพร่ระบบ

ขั้นต่อไป:
- เจ้าของตรวจคำขอตรวจทานหมายเลข 139 และอนุมัติแยกก่อนรวมเข้ากิ่งหลัก
